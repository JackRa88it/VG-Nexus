...
INSERT INTO Games (name, UserId, createdAt, updatedAt) VALUES
("Snake", 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
("Fish", 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
("Pig", 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
("Role Playing", 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
>>>>>>> 3c506d637f9e846a1f25eb7c0c606e4668fe7088
-- ("Rule #1: don't talk aobut VG Nexus. Rule #2: a cheeseburger a day keeps the doctor away. Rule #3: guess I'll just die then?", 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- ("absolute shitpost", 5, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- ("nice", 5, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
